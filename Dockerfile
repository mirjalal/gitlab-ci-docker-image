#
# A Docker file for GitLab Android CI: v1.0
# Build Tools: v29.0.2
# Platforms: 29
# https://hub.docker.com/r/mirjalal/gitlab-ci-docker-image
#

FROM ubuntu:18.04
LABEL maintainer mirjalal
...
# Install Google's repo tool version 1.26 (https://source.android.com/setup/build/downloading#installing-repo)
RUN curl -s https://storage.googleapis.com/git-repo-downloads/repo > /tmp/repo && \
    echo "0cf5f52bcafb8e1d3ba0271b087312f6117b824af272bedd4ee969d52363a86b  /tmp/repo" > /tmp/repo.sha265 && \
